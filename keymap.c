...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KC_A, LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G,       KC_H, RSFT_T(KC_J), RCTL_T(KC_K), RALT_T(KC_L), RGUI_T(KC_SCLN),
	KC_Z, KC_X, KC_C, KC_V, KC_B,                               KC_N, KC_M, KC_COMM, KC_DOT, KC_ENT,
	                            KC_GRV, LT(1,KC_BSPC), LT(2,KC_SPC), KC_TAB),

	[1] = LAYOUT_split_3x5_2(
	KC_BSLS, KC_7, KC_8, KC_9, KC_0,                            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	KC_MINS, KC_4, KC_5, KC_6, KC_LBRC,                         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
	...
	KC_LSFT, KC_F5, KC_F5, KC_F6, KC_F11,                       KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_QUOT,
	...
	KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	                            KC_GRV, KC_BSPC, LT(1,KC_SPC), KC_TRNS),
